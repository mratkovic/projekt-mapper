...
void Lis::calcLIS(std::vector<int>* result,
...
int Lis::estimateBeginingPosFromLIS(
...
void Lis::reconstructLIS(std::vector<int>* result, int lastPos,
                         int* reconstructionTable, int n) {
  result->clear();
  result->reserve(n);
